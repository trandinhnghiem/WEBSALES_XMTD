...
export default function CreateCustomer() {
  const [form, setForm] = useState({
    ...
    name: "",
    password: "",
    tax_code: "", // sửa từ taxCode -> tax_code
    address: "",
    provinces: [],
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setForm({ id: "", name: "", password: "", tax_code: "", address: "", provinces: [] });
        fetchAccounts();
        setShowForm(false);
      } else {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <h2 className="text-2xl font-semibold mb-6 text-center uppercase">Tài khoản người dùng</h2>
      ...
      {showForm && (
        <form onSubmit={handleSubmit} className="space-y-4 mb-8 border p-4 rounded shadow">
          ...
          <div>
            ...
            <input type="text" name="tax_code" value={form.tax_code} onChange={handleChange} className="w-full border rounded px-3 py-2" />
          </div>
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            >
              ...
              <svg className={`w-4 h-4 ml-2 transition-transform ${showDropdown ? "rotate-180" : ""}`}
